...
public class ImpactManager : MonoBehaviour
{
    ...
    Dictionary<Material, ImpactSetting> settingLookup = new Dictionary<Material,ImpactSetting>();
    ...
    void Start()
    {
        ...
        foreach (var impactSettings in ImpactSettings)
        {
            ...
            settingLookup.Add(impactSettings.TargetMaterial, impactSettings);
        }
    }
    ...
    public void PlayImpact(Vector3 position, Vector3 normal, Material material = null)
    {
        ...
        if (material == null || !settingLookup.TryGetValue(material, out setting))
        {
